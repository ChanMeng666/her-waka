...
## Going deeper: multi-week series

Ready for something bigger than a single task? The series below takes you across 8 weeks plus a 4-week capstone, building one cumulative AI-powered portfolio site.

<CardGroup cols={1}>
  <Card title="Build a Full-Stack AI Site (8 Weeks)" icon="rocket" href="/tutorial/ai-bootcamp/overview" color="#c846ab">
    A complete 8-week + 4-week-capstone bootcamp. By the end you own one live AI-powered portfolio site with auth, database, file storage, blog, real-time alerts, and AI-generated CV downloads. Every week ships as a downloadable PDF lecture.
  </Card>
</CardGroup>
