...
```mermaid
flowchart LR
    A["You describe\nwhat you need"] -->|"prompt"| B["Gemini CLI\nwrites Typst"]
...
You describe the document you need. Gemini CLI writes Typst code (a simple typesetting language). Typst compiles it into a beautiful PDF. Review, refine, and repeat until it's perfect.
