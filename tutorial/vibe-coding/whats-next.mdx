...
If you worked through the earlier tutorials, you have been building CLI skills step by step:

- **Gmail Summary:** First time using Gemini CLI in the terminal
- **Obsidian Daily / Organise:** Voice commands controlling apps through Gemini CLI
- **Auckland Commute / Personal Website:** Gemini CLI working with real APIs and live data
- **Professional PDF / Slack Summary:** Gemini CLI with MCP servers and extensions

Claude Code works the same way — you speak or type in the terminal, the AI does the work, and you approve the results. The only difference is that Claude Code is smarter and can handle full engineering projects. Everything you learned with Gemini CLI prepared you for this moment.
