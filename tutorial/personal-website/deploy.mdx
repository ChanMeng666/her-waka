...
description: "Publish your website to the internet for free using GitHub Pages — with step-by-step instructions and copy-paste prompts."
---
...
<Steps>
  <Step title="Create a GitHub repository and push your code">
    ...
    ```text title="Copy this prompt to create your GitHub repository"
  ...
  <Step title="Enable GitHub Pages">
    <Tabs>
      <Tab title="Using Gemini CLI">
        ...
        ```text title="Copy this prompt to enable GitHub Pages"
  ...
  <Step title="Wait and verify">
    ...
    **Seeing a 404 page?** Don't worry — wait another minute and refresh. First deployments can take up to 3 minutes.
    ...
    ```text title="Copy this prompt to check deployment status"
